...
namespace UiaPeek.Domain.UnitTests.Middlewares
{
    ...
    public sealed class KeyboardTargetResolverTests
    {
        ...
        public void KeyboardTargetClearRestoresFallbackTest()
        {
            ...
            resolver.ResolveDown(identity, keyText: "Enter");
            ...
            Assert.AreEqual(2, repository.FocusPeekCount);
        }
        ...
        public void KeyboardTargetExtendedIdentitySeparatesStateTest()
        {
            ...
            var repository = new FakeUiaPeekRepository(standardChain, extendedChain);
            var resolver = new KeyboardTargetResolver(repository);
            ...
            resolver.ResolveDown(standardIdentity, keyText: "Enter");
            resolver.ResolveDown(extendedIdentity, keyText: "Num Enter");
        ...
        public void KeyboardTargetIndependentKeysTest()
        {
            ...
            var repository = new FakeUiaPeekRepository(enterChain, tabChain);
            var resolver = new KeyboardTargetResolver(repository);
            ...
            resolver.ResolveDown(enterIdentity, keyText: "Enter");
            resolver.ResolveDown(tabIdentity, keyText: "Tab");
        ...
        public void KeyboardTargetPairedReleaseReusesPressTest()
        {
            ...
            var emptyChain = new UiaChainModel();
            var repository = new FakeUiaPeekRepository(cancelChain, emptyChain);
            var resolver = new KeyboardTargetResolver(repository);
            var identity = NewIdentity(virtualKey: 27, scanCode: 1, extended: false);

            // Act: resolve the Down and Up transitions around the dialog-closing key action.
            var downResolution = resolver.ResolveDown(identity, keyText: "Escape");
        ...
        public void KeyboardTargetRepeatedDownRetainsFirstPressTest()
        {
            ...
            var emptyChain = new UiaChainModel();
            var repository = new FakeUiaPeekRepository(firstChain, emptyChain);
            var resolver = new KeyboardTargetResolver(repository);
            ...
            var firstDown = resolver.ResolveDown(identity, keyText: "Tab");
            var repeatedDown = resolver.ResolveDown(identity, keyText: "Changed");
